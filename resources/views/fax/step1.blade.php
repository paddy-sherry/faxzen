...
<div class="bg-white rounded-lg shadow-md p-8">
    <div class="mb-8">
        ...
        <div class="text-center mb-6">
            <div class="inline-flex items-center space-x-6 bg-green-50 px-6 py-3 rounded-full border border-green-200">
                <div class="flex items-center space-x-2">
                    <svg class="w-5 h-5 text-green-600" fill="currentColor" viewBox="0 0 20 20">
                        <path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clip-rule="evenodd" />
                    </svg>
                    <span class="text-sm font-medium text-green-800">Quick & Easy</span>
                </div>
                <div class="flex items-center space-x-2">
                    <svg class="w-5 h-5 text-green-600" fill="currentColor" viewBox="0 0 20 20">
                ...
                <div class="flex items-center space-x-2">
                    ...
                    <span class="text-sm font-medium text-green-800">Instant</span>
                </div>
            </div>
        </div>
    </div>
